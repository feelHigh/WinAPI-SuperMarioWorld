...
namespace nto
{
	ForegroundFloorBox::ForegroundFloorBox()
        : bType(1)
        , bSwitch(false)
	{
	}
	...
	void ForegroundFloorBox::Initialize()
	{
	}

	void ForegroundFloorBox::Update()
	{
		GameObject::Update();
	...
	void ForegroundFloorBox::Render(HDC hdc)
	{
		GameObject::Render(hdc);
	}

	void ForegroundFloorBox::OnCollisionEnter(Collider* other)
	{
	...
	void ForegroundFloorBox::OnCollisionStay(Collider* other)
	{
	}

	void ForegroundFloorBox::OnCollisionExit(Collider* other)
	{
	}
}
